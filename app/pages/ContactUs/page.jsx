      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-900 rounded-full blur-3xl opacity-30 animate-pulse"></div>
            <Image
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-3xl p-8 shadow-2xl">
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-600 rounded-lg hover:from-blue-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 transform hover:scale-105 transition-all duration-300"
              >
