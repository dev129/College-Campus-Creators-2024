      ...
      <main className="bg-gradient-to-r from-blue-600 to-blue-900 min-h-screen text-white">
        <div className="container mx-auto px-4 py-16">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                <p className="text-gray-300 text-lg mb-4 text-justify">
                  This hackathon is organised by debuggers in association with
                  Institute Innovation Cell where students from all branches
                  come together to build amazing projects for colleges. It's a
                  great opportunity to network, learn new skills, and have fun!
                </p>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                <ul className="list-disc ml-6 text-gray-300 space-y-2 text-justify text-lg">
                  <li>
                    Hone your skills across various disciplines - not just
                    coding!
                  </li>
                  <li>
                    Perfect starting point for your hackathon journey,
                    regardless of your branch.
                  </li>
                  <li>
                    Network with diverse minds and form interdisciplinary
                    connections.
                  </li>
                  <li>
                    Challenge yourself to create innovative solutions with
                    limited resources.
                  </li>
                  <li>
                    Gain exposure to real-world problems and industry mentors.
                  </li>
                </ul>
              </div>
              <div className="md:w-1/2 relative h-64 w-full">
              ...
              {[
                {
                  ...
                  title: "Form Teams",
                  content:
                    "Create diverse teams with members from different branches",
                },
                {
                  number: 2,
                  title: "Register",
                  content: "Sign up before  Sep 10th",
                },
                {
                  number: 3,
                  title: "Ideate",
                  content:
                    "Brainstorm and present your ideas on Sep 15th (Beginners) & Sep 25th (All)",
                },
                {
                  number: 4,
                  title: "Hack",
                  content:
                    "Finalists bring their A-game to build solutions on September 30th",
                },
              ].map((step, index) => (
                <div key={index} className="text-center">
                  <div className="text-5xl md:text-6xl mb-4 text-blue-400">
                    {step.number}
                  </div>
          ...
          <section className="mb-16 bg-gray-900 p-8 rounded-3xl shadow-lg hover:shadow-purple-400 transition-all duration-300">
              ...
              {[
                {
                  ...
                  description:
                    "Develop eco-friendly solutions for college sustainability",
                },
                {
                  icon: "🤖",
                  theme: "AI for Education",
                  description: "Leverage AI to enhance learning experiences",
                },
                {
                  icon: "🏥",
                  theme: "HealthTech Innovation",
                  description:
                    "Create solutions for student health and wellness",
                },
                {
                  icon: "🎨",
                  theme: "Creative Arts & Tech",
                  description:
                    "Blend technology with arts for campus enrichment",
                },
                {
                  icon: "🔬",
                  theme: "Science & Engineering",
                  description:
                    "Tackle complex problems with cutting-edge tech in the field  of engineering",
                },
                {
                  icon: "🌐",
                  theme: "Smart Campus",
                  description:
                    "IoT and digital solutions for a connected campus",
                },
              ].map((item, index) => (
                <div
                  key={index}
            ...
            <div
              className="text-4xl md:text-6xl mt-12 text-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600"
          ...
          <section className="mb-16 bg-gray-900 p-8 rounded-3xl shadow-lg hover:shadow-yellow-400 transition-all duration-300">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-green-400 text-center divider divider-accent pb-5">
              Prizes
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  medal: "Gold",
                  place: "1st Place",
                  prize: "Goodies, Vouchers & Winner Certificate",
                },
                {
                  medal: "Silver",
                  place: "2nd Place",
                  prize: "Swags & Achievement Certificate",
                },
                {
                  medal: "Bronze",
                  place: "3rd Place",
                  prize: "Perks & Recognition Certificate",
                },
              ].map((prize, index) => (
                <div
                  key={index}
          ...
          <section className="mb-10 bg-gray-900 p-8 rounded-3xl shadow-lg hover:shadow-purple-400 transition-all duration-300">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-green-400 text-center divider divider-accent">
              FAQs
            </h2>
            <FAQ />
          </section>
          ...
          <div className="text-center">
            <h2 className="text-3xl md:text-5xl text-white font-bold mb-6">
              You still need reasons to participate ?
            </h2>
