  ...
  return (
    <main className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/2">
            <ul className="list-disc ml-6 text-gray-300 space-y-2">
              ...
              <li>No need to integrate backend (database, APIs etc.).</li>
            </ul>
          </div>
          <div className="md:w-1/2 relative h-64 w-full">
            <Image
      ...
      <section className="mb-16 bg-gray-900 p-8 rounded-3xl shadow-lg hover:shadow-neon-orange transition-all duration-300">
        ...
        <p className="text-gray-300 mb-4">
          Create something that benefits our college community! Below are some ideas which you can try solving.
        </p>
        <div className="bg-gray-800 p-4 rounded-xl">
          <h3 className="text-2xl font-semibold mb-2 text-neon-pink">
            Potential Areas:
      ...
      <section className="bg-gray-900 text-white p-8 rounded-3xl shadow-lg hover:shadow-neon-blue transition-all duration-300 mt-16">
      <h2 className="text-4xl font-bold mb-6 text-neon-pink">
